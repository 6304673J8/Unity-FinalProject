...
//     version 1.6.1
//     from Assets/Inpuctations/PlayerInputs.inputactions
//
...
public partial class @PlayerInputs: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""bindings"": [
                ...
                {
                    ""name"": ""ArrowKeys"",
                    ""id"": ""fe61c1c4-9b53-4dcb-8541-9f8b4b28aa15"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""efb67578-9209-4fce-b1f1-32d88abe9384"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""b6cc8fb7-0823-4397-8ebf-48ebe2be42b6"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""97478971-46fc-4e1c-9ccc-f0804d0f8f2d"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""c0eeb13e-70d5-42c6-b8cd-3bb33e4d1eb5"",
    ...
    private List<ISusanaActions> m_SusanaActionsCallbackInterfaces = new List<ISusanaActions>();
    ...
    public struct SusanaActions
    {
        ...
        public void AddCallbacks(ISusanaActions instance)
        {
            if (instance == null || m_Wrapper.m_SusanaActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_SusanaActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ISusanaActions instance)
        {
            @Move.started -= instance.OnMove;
            @Move.performed -= instance.OnMove;
            @Move.canceled -= instance.OnMove;
        ...
        public void RemoveCallbacks(ISusanaActions instance)
        {
            if (m_Wrapper.m_SusanaActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ISusanaActions instance)
        {
            foreach (var item in m_Wrapper.m_SusanaActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_SusanaActionsCallbackInterfaces.Clear();
